...
const SETTLEMENT_NETWORK_TEXT_KEYS = [
  ...
  "settlement_network_body",
  "settlement_network_no_missions",
  "settlement_network_mission_count",
  "settlement_network_no_outposts",
  "settlement_network_outpost_count",
  "settlement_network_start_recon",
  "settlement_network_start_recon_description",
  "settlement_network_build_outpost",
  "settlement_network_build_outpost_description",
  "settlement_network_outpost_limit",
  "settlement_network_mission_format",
  "settlement_network_mission_ready",
  "settlement_network_mission_progress",
  "settlement_network_outpost_format",
  "settlement_network_outpost_summary",
  "settlement_recon_city_title",
  "settlement_recon_city_body",
  "settlement_recon_city_format",
  "settlement_recon_city_detail",
  "settlement_recon_companion_title",
  "settlement_recon_companion_body",
  "settlement_recon_companion_format",
  "settlement_recon_no_companion",
  "settlement_city_status_unlocked",
  "settlement_city_status_active",
  "settlement_city_status_available",
  "settlement_city_status_locked",
  "settlement_recon_transport_ready",
  "settlement_recon_transport_locked",
  "settlement_recon_already_unlocked",
  "settlement_recon_already_active",
  "settlement_recon_need_intelligence",
  "settlement_recon_need_transport",
  "settlement_recon_need_companion",
  "outpost_build_city_title",
  "outpost_build_city_body",
  "outpost_build_city_format",
  "outpost_build_city_locked",
  "outpost_build_city_full",
  "outpost_build_district_title",
  "outpost_build_district_body",
  "outpost_build_district_occupied",
  "outpost_build_type_title",
  "outpost_build_location_format",
  "outpost_build_type_body",
  "outpost_build_type_format",
  "outpost_detail_title",
  "outpost_detail_title_format",
  "outpost_detail_body",
  "outpost_detail_no_companion",
  "outpost_assign_companion",
  "outpost_assign_companion_description",
  "outpost_recall_companion_format",
  "outpost_recall_companion_description",
  "outpost_supply",
  "outpost_supply_ready",
  "outpost_supply_waiting",
  "outpost_assign_title",
  "outpost_assign_location_format",
  "outpost_assign_body",
  "outpost_assign_no_companion",
  "outpost_assign_companion_format",
] as const;
const TEXT_KEYS = [
  ...SETTLEMENT_NETWORK_TEXT_KEYS,
  "loading",
  "load_failed",
  "connection_title",
  "start_single",
  ...
  "research_body",
  "research_slot_empty",
  "research_slot_filled_format",
  "research_slot_candidate_format",
  "research_slot_candidate_detail_format",
  "research_slot_clear",
  "research_sample_format",
  "research_source_format",
  "research_sample_slotted",
  "research_sample_not_slotted",
  ...
  "expedition_item_increase",
  "expedition_item_decrease",
  "expedition_selected",
  ...
  "archive_storage_title",
  "archive_storage_body",
  "archive_storage_empty",
  "archive_collected_format",
  "archive_unlocked_format",
  "archive_open_collection",
  "archive_open_document",
  "archive_locked_document",
  "archive_requirement_format",
  "archive_document_metadata_format",
  "encounter_catalog_title",
  "encounter_catalog_body",
  "encounter_catalog_empty",
  "encounter_roster_format",
  "encounter_threat_format",
  "encounter_start",
  "encounter_unavailable",
  "encounter_preparation_title_format",
  "encounter_preparation_body",
  "encounter_preparation_supply_format",
  "encounter_preparation_roster_title",
  "encounter_preparation_assignment_required",
  "encounter_preparation_ready",
  "encounter_preparation_medical_shortage",
  "encounter_preparation_attribute_format",
  "encounter_preparation_role_unassigned",
  "encounter_preparation_role_format",
  "encounter_preparation_role_effect_format",
  "encounter_preparation_treatment",
  "encounter_preparation_treatment_cancel",
  "encounter_preparation_treatment_selected",
  "encounter_preparation_treatment_full",
  "encounter_preparation_treatment_available",
  "encounter_preparation_treatment_unavailable",
  "encounter_preparation_start",
  "encounter_round_format",
  "encounter_outcome_ongoing",
  "encounter_outcome_victory",
  "encounter_outcome_defeat",
  "encounter_outcome_retreated",
  "encounter_instruction",
  "encounter_party_title",
  "encounter_enemy_title",
  "encounter_row_front",
  "encounter_row_back",
  "encounter_empty_party",
  "encounter_empty_enemy",
  "encounter_intent_title",
  "encounter_empty_intent",
  "encounter_pending_title",
  "encounter_pending_format",
  "encounter_action_title",
  "encounter_empty_action",
  "encounter_action_detail_format",
  "encounter_target_title",
  "encounter_empty_target",
  "encounter_target_format",
  "encounter_log_title",
  "encounter_empty_log",
  "encounter_execute",
  "encounter_finish",
  "encounter_health_format",
  "encounter_status_pending",
  "encounter_status_acted",
  "encounter_status_guarding",
  "encounter_status_down",
  "encounter_action_available",
  "encounter_action_unavailable",
  "encounter_action_attack",
  "encounter_action_guard",
  "encounter_action_skill",
  "encounter_action_item",
  "encounter_action_retreat",
  "return_incident_choice_title",
  "return_incident_empty",
  "return_incident_defer",
  "return_incident_requirement_met",
  "return_incident_result_preview",
  ...
  "profile_trait_label",
  "profile_secondary_trait_label",
  "profile_city_label",
  "profile_district_label",
  "profile_shelter_type_label",
  "profile_shelter_detail_format",
  "profile_shelter_bonus_separator",
  "profile_slot_label",
  ...
  "companion_weapon",
  "companion_armor",
  "companion_empty_slot",
  "companion_unequip",
  "companion_equipment_quantity_format",
  "companion_equipment_unowned",
  ...
  "management_repetition_cycle_format",
  "management_repetition_confirm_format",
  "shelter_wall_summary_format",
...
function parseNewGameSetupCopy(value: unknown): NewGameSetupConfig["copy"] {
  ...
  return {
    ...
    incompatible_mark: expectString(source.incompatible_mark, "new_game_setup.copy.incompatible_mark"),
...
function parseGuidedTutorial(value: unknown): GuidedTutorialConfig {
  ...
  return {
    ...
    page_format: expectString(source.page_format, "guided_tutorial.page_format"),
    page_separator: expectString(source.page_separator, "guided_tutorial.page_separator"),
    previous_label: expectString(source.previous_label, "guided_tutorial.previous_label"),
    previous_page_label: expectString(source.previous_page_label, "guided_tutorial.previous_page_label"),
    next_label: expectString(source.next_label, "guided_tutorial.next_label"),
    next_page_label: expectString(source.next_page_label, "guided_tutorial.next_page_label"),
    ...
    dialog_target_gap: expectNumber(source.dialog_target_gap, "guided_tutorial.dialog_target_gap"),
    ...
    minimum_page_fill_ratio: expectSplitRatio(
      source.minimum_page_fill_ratio,
      "guided_tutorial.minimum_page_fill_ratio",
    ),
